...
const columns: FooterColumn[] = [
  ...
  {
    // ลิงก์ 4 อันนี้เคยชี้ไปหน้าที่ยังไม่มีจริง (404) — ยังไม่มีหน้าเนื้อหารองรับ จึงตัด href
    // ออกก่อน (โชว์เป็นข้อความเฉยๆ กดไม่ได้) กันคลิกโดนแล้วเจอหน้า error ระหว่างพรีเซนต์ ใส่
    // href กลับได้ทันทีเมื่อมีหน้า /help, /help/shipping, /help/warranty, /about จริงแล้ว
    title: "ช่วยเหลือ",
    items: [
      { label: "คำถามที่พบบ่อย" },
      { label: "การจัดส่งสินค้า" },
      { label: "นโยบายการรับประกัน" },
      { label: "เกี่ยวกับเรา" },
    ],
  },
